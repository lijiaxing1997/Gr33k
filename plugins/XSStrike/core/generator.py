from plugins.XSStrike.core.config import xsschecker, badTags, fillings, eFillings, lFillings, jFillings, eventHandlers, tags, functions
from plugins.XSStrike.core.jsContexter import jsContexter
from plugins.XSStrike.core.utils import randomUpper as r, genGen, extractScripts
