...
from plugins.XSStrike.core.colors import end, red, green, yellow
from plugins.XSStrike.core.config import fuzzes, xsschecker
from plugins.XSStrike.core.requester import requester
from plugins.XSStrike.core.utils import replaceValue, counter
