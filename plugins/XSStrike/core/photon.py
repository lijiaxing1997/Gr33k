...
from plugins.XSStrike.core.zetanize import zetanize
from plugins.XSStrike.plugins.retireJs import retireJs

logger = setup_logger(__name__)


def photon(seedUrl, headers, level, threadCount, delay, timeout, skipDOM,signal=None):
    forms = []  # web forms
    ...
    def rec(target):
        ...
        response = requester(url, params, headers, True, delay, timeout,signal=signal).text
