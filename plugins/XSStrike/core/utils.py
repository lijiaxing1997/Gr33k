...
def getVar(name):
    return plugins.XSStrike.core.config.globalVariables[name]

def updateVar(name, data, mode=None):
    if mode:
        if mode == 'append':
            plugins.XSStrike.core.config.globalVariables[name].append(data)
        elif mode == 'add':
            plugins.XSStrike.core.config.globalVariables[name].add(data)
    else:
        plugins.XSStrike.core.config.globalVariables[name] = data
